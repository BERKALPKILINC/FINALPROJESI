...
@Component({
  selector: 'app-merakedilenler',
  templateUrl: './merakedilenler.component.html',
  styleUrls: ['./merakedilenler.component.css']
})
export class MerakedilenlerComponent implements OnInit {
  kayitlar: any;
