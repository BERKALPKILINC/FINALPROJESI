...
@Component({
  selector: 'app-merakedilenlerkayit',
  templateUrl: './merakedilenlerkayit.component.html',
  styleUrls: ['./merakedilenlerkayit.component.css']
})
export class MerakedilenlerkayitComponent implements OnInit {
  kayitlar: any;
